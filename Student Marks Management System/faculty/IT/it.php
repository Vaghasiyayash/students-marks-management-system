...
<body style="background-color:;background:linear-gradient(to right,rgb(230, 238, 239) 30%,rgb(188, 205, 207) 60%) ">
 ...
 <form action="ientry.php" name="form" id="form" method="get" onsubmit="return(validate());" style="display: inline-block;height: 300px;width: 500px;">
          <table>
              <tr>
      ...
      <form action="iupdate.php" name="form2" id="form2" method="get" onsubmit="return(validate1());" style="display: inline-block;height: 300px;width: 500px;">
          <table>
             <tr>
      ...
      <form action="idelete.php" name="form3" id="form3" method="get"  style="display: inline-block;height: 300px;width: 200px;">
          <table>
             <tr>
               ...
               <tr >
                ...
                <td style="width:200px">
                      <a style="text-decoration:none" 
                            href="it.php?Id='.$row["Id"].'&Enrollment_No='.$row["Enrollment_No"].' &StudentName='.$row["StudentName"].'&Branch='.$row["Branch"].'&Subject='.$row["StudentName"].' &Ten='.$row["Ten"].' &Twenty='.$row["Twenty"].' &Total='.$row["Total"].' &Status='.$row["Status"].'" >
